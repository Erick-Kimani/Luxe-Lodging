      ...
      <v-row class="px-4">
        ...
        >
          <div class="card-border-wrapper">
            <v-card class="Service-card" elevation="0" @click="viewDetails(Service)">
              <div class="image-wrapper">
                <v-img :src="Service.image" height="200" cover />
              </div>
      ...
      <v-row v-if="filteredServices.length === 0">
        <v-col cols="12" class="text-center">
          <p class="text-grey-lighten-1 mt-6">
            No Services found matching "<strong>{{ searchQuery }}</strong>"
          </p>
        </v-col>
      </v-row>
    </v-container>
