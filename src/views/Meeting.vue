      ...
      <v-row class="px-4">
        ...
        >
          <div class="card-border-wrapper">
            <v-card class="Meeting-card" elevation="0" @click="viewDetails(Meeting)">
              <div class="image-wrapper">
                <v-img :src="Meeting.image" height="200" cover />
              </div>

              <v-card-text class="pt-4">
                <h3 class="card-title">{{ Meeting.name }}</h3>
                <p class="price">Price: {{ Meeting.price }}</p>
